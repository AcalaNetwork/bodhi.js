...
```
docker run -it --rm -p 9944:9944 -p 9933:9933 ghcr.io/acalanetwork/mandala-node:sha-0910ce3 --dev --instant-sealing --ws-external --rpc-port=9933 --rpc-external --rpc-cors=all --rpc-methods=unsafe
```
