...
interface LinkdropFactoryERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class LinkdropFactoryERC20 extends BaseContract {
  ...
  interface: LinkdropFactoryERC20Interface;
