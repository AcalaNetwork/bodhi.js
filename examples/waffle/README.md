...
```
docker run -it --rm -p 9944:9944 -p 9933:9933 acala/mandala-node:01a2dea6 --dev --instant-sealing --ws-external=true --rpc-port=9933 --rpc-external=true --rpc-cors=all --rpc-methods=unsafe
```
