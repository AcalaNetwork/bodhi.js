...
interface LinkdropFactoryCommonInterface extends ethers.utils.Interface {
  functions: {
...
export class LinkdropFactoryCommon extends BaseContract {
  ...
  interface: LinkdropFactoryCommonInterface;
