...
interface LinkdropFactoryERC721Interface extends ethers.utils.Interface {
  functions: {
...
export class LinkdropFactoryERC721 extends BaseContract {
  ...
  interface: LinkdropFactoryERC721Interface;
