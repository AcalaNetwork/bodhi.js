...
describe('eth_getTransactionReceipt', () => {
  ...
  it('returns correct result when hash exist for local transactions', async () => {
    ...
    expect(res.data.result).to.deep.equal({
      ...
      effectiveGasPrice: '0x19a8bd8fa81',
      status: '0x1',
      type: '0x0'
    });
    ...
    expect(res.data.result).to.deep.equal({
      ...
      blockNumber: '0x9',
      cumulativeGasUsed: '0x0', // FIXME:
      effectiveGasPrice: '0x16038938c24',
      status: '0x1',
      type: '0x0'
    });
    ...
    expect(res.data.result).to.deep.equal({
      ...
      blockNumber: '0x6',
      cumulativeGasUsed: '0x0', // FIXME:
      effectiveGasPrice: '0x19ab79f8f2f',
      status: '0x1',
      type: '0x0'
    });
  });
