...
import { Provider, TransactionReceipt, TransactionRequest, TransactionResponse } from "./Provider";
...
function handleTxResponse(result: SubmittableResult, api: any): Promise<{
...
export class Wallet extends Signer implements ExternallyOwnedAccount, TypedDataSigner {
  ...
  async claimEvmAccounts() {
    const data = 'acala evm:' + Buffer.from(this.keyringPair.publicKey).toString('hex')
